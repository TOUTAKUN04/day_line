...
class TaskAlarmReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (!started) {
            ...
            AlarmNotificationHelper.showFallbackNotification(context, title, time, date, "Starts now")
        }
    }

    companion object {
        const val ACTION_START = "com.example.dailyflow.action.START_TASK_ALARM"
